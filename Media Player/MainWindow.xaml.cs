...
namespace Media_Player
{
    ...
    public partial class MainWindow : ctrl.Window
    {
        ...
        String[] categories = {"Action", "Adventure", "Fantasy", "Horror", "History", "Romance", "Sci-fi", "Western"};
        ...
        public MainWindow()
        {
            ...
            {
                Border category_button_border = new()
                {
                    Height = 28,
                    BorderThickness = new Thickness(0, 0, 0, 0),
                    Style = (Style)System.Windows.Application.Current.Resources["category_button_border"],
                ...
                //category_button_border.Child= category_button;
